	...
	class WWP_Wholesale_Pricing_Backend {
		...
		public function wwp_admin_script_style() {
			...
			if( get_current_screen()->id == 'toplevel_page_wwp_wholesale' ) {
				wp_enqueue_script( 'wwp-bootstrap', WWP_PLUGIN_URL . 'assets/js/bootstrap.min.js' );
			}
		}
			...
			if ( isset($_POST['save-wwp_wholesale']) ) {
				if ( isset($_POST['wwp_wholesale_register_nonce']) || wp_verify_nonce( wc_clean($_POST['wwp_wholesale_register_nonce']), 'wwp_wholesale_register_nonce') ) {
					...
					if( isset( $_POST['options']['tier_pricing'] ) && is_array( $_POST['options']['tier_pricing'] ) ) {
						...
						$min_array 		= (array) array_filter( $_POST['options']['tier_pricing']['min'] );
						$max_array 		= (array) array_filter( $_POST['options']['tier_pricing']['max'] );
						$value_array 	= (array) array_filter( $_POST['options']['tier_pricing']['value'] );
								...
								<table class="form-table">
										...
										<tr scope="row">
											...
											<td>
												...
												<p>Select the page on which you want to redirect the user when clicking on registration link on my-account page.</p>
											</td>
										</tr>
										<tr scope="row">
											...
											?>
												...
												<p>Please select a page or product to redirect after a successful registration.</p>
											</td>
										</tr>
										<tr scope="row">
											...
											<p>
													...
													<p>Select option to send wholesale order notification email.</p>
											</p>
										...
										<tr scope="row">
											<th><label for="">Send Email CC/BCC</label></th>
											<td>
											<p>
													...
													</p><p>Select option to send wholesale order notification email in CC/BCC</p>
											<p></p>
										...
										<tr scope="row" id="select_role_wrap">
											...
											<td>
												...
												<p>Select a role of email notifications.</p>
											</td>
										</tr>
										<?php 
										...
										<tr scope="row" id="select_email_custom_wrap">
											...
											<p>Enter recipients (comma separated)</p>
											</td>
										</tr>
								</table>
							</div>
											...
											<div class="modal-dialog modal-lg modal-dialog-centered">
												<div class="modal-content">
													...
													<div class="modal-body">
														...
														<?php for( $i = 0; $i < 3; $i++ ): ?>
															<?php echo wwp_global_tier_pricing_html( $i ); ?>
														<?php endfor; ?>
													</div>
