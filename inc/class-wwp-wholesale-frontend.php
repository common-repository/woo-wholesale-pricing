...
if ( !class_exists('Wwp_Wholesale_Pricing_Frontend') ) {
	...
	class Wwp_Wholesale_Pricing_Frontend {
		...
		public function email_recipeint_bcc_cc( $recipients, $id, $obj, $abcd ) {

			if ( 'new_order' != isset($id) ) {					
				return $recipients;
			}
		...
		/**
		 * Method wholesale_new_order_email_recipient
		 *
		...
		public function wholesale_new_order_email_recipient( $recipient, $order ) {
			...
			if ( isset( $settings['emailuserrole'] ) && ( 'order_email_user_role' == $settings['emailuserrole'] || 'order_email_custom' == $settings['emailuserrole'] ) ) {
				...
				} elseif ( 'order_email_custom' == $settings['emailuserrole'] && ! empty( $settings['order_custom_email_value'] ) ) {
					$recipient .= ',' . sanitize_email( $settings['order_custom_email_value'] );
				}
			}
			return $recipient;
		}
